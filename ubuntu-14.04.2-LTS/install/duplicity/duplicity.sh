...
echo -e "\033[1;33m=========[INSTALLING duplicity]========\033[0m"
echo -e "\033[1;33m=                                     =\033[0m"
...
echo -e "\033[1;32mDuplicity has been installed correctly\033[0m"
echo -e "\033[1;32mduplicity-backup is a shell script to simplify and automate it\033[0m"
# Start a backup
#cd ~/duplicity-backup
